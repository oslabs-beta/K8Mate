...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  let classes = clsx(
    ...
    // Hover
    'data-[hover]:bg-zinc-950/5 data-[slot=icon]:*:data-[hover]:fill-superPurple',
    // Active
    'data-[active]:bg-zinc-950/5 data-[slot=icon]:*:data-[active]:fill-superPurple',
    // Current
    'data-[slot=icon]:*:data-[current]:fill-superPurple',
    // Dark mode
