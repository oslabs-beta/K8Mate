...
const styles = {
  ...
  colors: {
    ...
    superPurple: [
      'text-white', // Example of text color for superPurple
      '[--btn-hover-overlay:theme(colors.white/10%)]',
      '[--btn-bg:#6001D2]', // Use your specific superPurple color
      '[--btn-border:theme(colors.purple.700/90%)]',
      '[--btn-icon:theme(colors.purple.300)]',
      'data-[active]:[--btn-icon:theme(colors.purple.200)]',
      'data-[hover]:[--btn-icon:theme(colors.purple.200)]',
    ],
  },
}
